...
public class App {
	...
	public static void main(String[] args) {
		...
		Juridica pessoaJur1 = new Juridica("Pessoa 1", "4645434365746", 500);
		Juridica pessoaJur2 = new Juridica("Pessoa 2", "64654344704", 250);
		
		Fisica pessoa2 = new Fisica("João da Silva", "324465452", "876543245");
		Fisica pessoa3 = new Fisica("Zezin da Costa", "654376543333", "212256543569");
